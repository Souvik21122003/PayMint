...
const Slider = React.forwardRef(({ className, ...props }, ref) => React.createElement(
  ...
  React.createElement(SliderPrimitive.Track, { className: "relative h-2 w-full grow overflow-hidden rounded-full bg-secondary" }, React.createElement(SliderPrimitive.Range, { className: "absolute h-full bg-primary" })),
